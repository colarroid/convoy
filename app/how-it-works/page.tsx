  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="bg-[#f5f4f1] px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto max-w-6xl">
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.25em] text-gray-600">Two ways to ride</p>
      ...
      <section className="bg-white px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto max-w-6xl">
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.25em] text-gray-600">What makes it work</p>
          <h2 className="max-w-3xl text-3xl font-bold tracking-tight text-black md:text-5xl">
