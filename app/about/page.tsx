      ...
      <section className="bg-white px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="text-[26px] font-bold leading-[1.35] tracking-tight text-black md:text-[38px] md:leading-[1.3]">
            Every day, neighbours head to the same place and travel there alone. We think that is a missed connection. Veesaa turns those separate journeys into shared ones, bringing you closer to the people in your community.
          </p>
        </div>
      </section>
...
const REASONS: { title: string; body: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    ...
    body: 'Your community code anchors one end of the trip, the place you are heading to or coming back from, and at the same time it shows you have access to that community. No addresses to compare, no guesswork.',
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden>
