    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="bg-white px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto max-w-4xl">
          <p className="mb-8 text-xs font-bold uppercase tracking-[0.15em] text-gray-600">The belief behind Veesaa</p>
      ...
      <section className="bg-[#f5f4f1] px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-2xl">
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.15em] text-gray-600">Why we are building this</p>
      ...
      <section className="bg-white px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto max-w-6xl">
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.15em] text-gray-600">What we stand for</p>
