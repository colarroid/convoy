    ...
    <div className="relative w-full max-w-[560px]">
      <div className="relative overflow-hidden rounded-[28px] bg-[#f3f5fb] ring-1 ring-black/5 shadow-[0_40px_90px_-50px_rgba(20,24,60,0.35)]">
        <svg viewBox="0 0 560 560" className="block w-full h-auto" role="img" aria-label="Neighbours matched on a shared ride to Riverside Hall">
          ...
          {/* ---- routes converging on the destination (430,210) ---- */}
          {/* blue route from NW pickup */}
          <path className="hm-route hm-route-blue" d="M120 210 C 220 150, 320 170, 430 210" fill="none" stroke="#2563eb" strokeWidth="5" strokeLinecap="round" />
          {/* black route from SW pickup */}
          <path className="hm-route hm-route-dark" d="M150 470 C 250 430, 330 320, 430 210" fill="none" stroke="#0a0a23" strokeWidth="5" strokeLinecap="round" />
          {/* blue onward leg to SE */}
          <path className="hm-route hm-route-blue2" d="M430 210 C 470 320, 500 400, 520 470" fill="none" stroke="#2563eb" strokeWidth="5" strokeLinecap="round" />
      ...
      <style jsx>{`
        .hm-route {
          ...
          animation: hm-draw 2.6s ease-out forwards;
        }
        .hm-route-dark { animation-delay: 0.5s; }
        .hm-route-blue2 { animation-delay: 1.5s; }
        @keyframes hm-draw {
          to { stroke-dashoffset: 0; }
        }
        .hm-node { transform-box: fill-box; transform-origin: center; animation: hm-pop 0.5s ease-out both; }
        .hm-node-2 { animation-delay: 0.6s; }
        .hm-node-3 { animation-delay: 2s; }
        @keyframes hm-pop {
        ...
        .hm-card { animation: hm-rise 0.6s ease-out 1.8s both; }
        @keyframes hm-rise {
